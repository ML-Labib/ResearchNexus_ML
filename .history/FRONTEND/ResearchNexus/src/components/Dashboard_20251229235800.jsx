...
function Dashboard({ user, userType }) {
 ...
 const handleDeleteFolder = async (id) => {
  ...
  //ML
  {/* ... end of your folders/files layout ... */}
...
<RecycleBinModal 
  ...
  user={user}
  onRestore={() => {
     // This refreshes the dashboard when you restore something
     loadFolders(); 
     if (selectedFolder) {
       // If you have a loadFiles function, call it here
       // loadFiles(selectedFolder.id); 
       
       // Or just clear selection to be safe
       setSelectedFolder(null); 
       setFiles([]);
     }
  }}
